    ...
    <div class="w3-row-padding">
        ...
        <div class="panel-body">
                                ...
                                @foreach($solicitude->features as $feature)
                                    <div class="col-lg-8">
                                        ...
                                        <p class="form-control-static"><i
                                                    class="glyphicon glyphicon-check"></i> {{$feature->name}}</p>
                                    </div>
                                @endforeach
                            </label>
                        </div>
            ...
            <div class="well well-sm">
                ...
                <a class="btn btn-warning" href="{{ route('solicitudes.edit', $solicitude->id) }}"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                ...
                <a class="btn btn-url  pull-right" href="{{  URL::previous() }}"><i
