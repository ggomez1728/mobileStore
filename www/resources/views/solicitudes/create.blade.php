        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('solicitudes.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('mobile')) has-error @endif">
                    ...
                    <input type="text" id=" id_client-field" name=" id_client" class="form-control" value="{{ old(" id_client") }}"/>
                    ...
                    <textarea class="form-control" id=" fails-field" rows="3" name=" fails">{{ old(" fails") }}</textarea>
                       @if($errors->has(" fails"))
